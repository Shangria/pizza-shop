        ...
        <div className="py-8">
            ...
            <div className="w-full">
                <div className=" w-full  mb-6">
                    <Image className="rounded-t-3xl" width={1200} height={300} src="/pizza-bg2.png" alt="pizza"/>
                </div>
                ...
                <div className="w-full ">
                    <Image className="rounded-b-3xl" width={1200} height={300} src="/pizza-bg.png" alt="pizza"/>
