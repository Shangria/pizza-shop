    ...
    return (
        <div className="py-8">
            ...
            <div className="w-full">
                ...
                <p className="text-xl text-gray-500 mb-6">When creating Pizza shop we wanted to combine two things people
                ...
                <div className="w-full h-[370px] relative ">
                    <Image className="rounded-b-3xl" layout="fill" objectFit="fill" src="/pizza-bg.png" alt="pizza"/>
